...
from .views import Create, InvitedToList, CreatedList, InvitationCreate, InvitationUpdate

urlpatterns = [
    path('new/', Create.as_view()),
    path('<int:event_id>/invite/', InvitationCreate.as_view()),
    path('invitation/<int:invitation_id>/respond/', InvitationUpdate.as_view()),
